/*    Palmer Ford
 *    circuitSatisfiabilitySlices finds the number of solutions in checkCircuit() using the slices method to compute it in parallel
 *    Calvin University
 *    October 25, 2023
 *    for Cs 374, project 1
 *
 * circuitSatifiabilitySlices.c solves the Circuit Satisfiability
...
int main (int argc, char *argv[]) {
   ...
   // Loop through input range, check the circuit, update count, and cycle through numProcesses
